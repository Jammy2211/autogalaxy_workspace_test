...
The galaxy's light is derived from a Multi-Gaussian Expansion (asymmetric) fit to a massive elliptical galaxy.

The model is sufficently complex to capture irregular and asymmetric features in the galaxy, including a twist in the
isophotes of its emission.
"""
# %matplotlib inline
...
`/autogalaxy_workspace/dataset/imaging/light_sersic_exp`
"""
