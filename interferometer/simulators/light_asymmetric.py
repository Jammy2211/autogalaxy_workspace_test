...
`/autogalaxy_workspace/dataset/interferometer/light_asymmetric`
"""
...
"""
grid_2d = ag.Grid2D.uniform(shape_native=(800, 800), pixel_scales=0.05, sub_size=1)
...
The parameters of these Gaussians are loaded from the file `galaxy_mge.json` and thei parameters were inferred by
