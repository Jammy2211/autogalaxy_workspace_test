...
bulge.ell_comps.ell_comps_0 = af.UniformPrior(lower_limit=-1.0, upper_limit=1.0)
bulge.ell_comps.ell_comps_1 = af.UniformPrior(lower_limit=-1.0, upper_limit=1.0)

disk = af.Model(ag.lp.Exponential)

disk.ell_comps.ell_comps_0 = af.UniformPrior(lower_limit=-1.0, upper_limit=1.0)
disk.ell_comps.ell_comps_1 = af.UniformPrior(lower_limit=-1.0, upper_limit=1.0)
